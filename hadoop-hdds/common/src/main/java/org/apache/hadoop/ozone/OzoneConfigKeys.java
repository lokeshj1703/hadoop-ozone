...
public final class OzoneConfigKeys {
  ...
  public static final String DFS_RATIS_CLIENT_REQUEST_WRITE_TIMEOUT =
      ScmConfigKeys.DFS_RATIS_CLIENT_REQUEST_WRITE_TIMEOUT;
  public static final TimeDuration DFS_RATIS_CLIENT_REQUEST_WRITE_TIMEOUT_DEFAULT =
      ScmConfigKeys.DFS_RATIS_CLIENT_REQUEST_WRITE_TIMEOUT_DEFAULT;
  public static final String DFS_RATIS_CLIENT_REQUEST_WATCH_TIMEOUT =
      ScmConfigKeys.DFS_RATIS_CLIENT_REQUEST_WATCH_TIMEOUT;
  public static final TimeDuration DFS_RATIS_CLIENT_REQUEST_WATCH_TIMEOUT_DEFAULT =
      ScmConfigKeys.DFS_RATIS_CLIENT_REQUEST_WATCH_TIMEOUT_DEFAULT;
  public static final String DFS_RATIS_CLIENT_MULTILINEAR_RANDOM_RETRY_POLICY =
      ScmConfigKeys.DFS_RATIS_CLIENT_MULTILINEAR_RANDOM_RETRY_POLICY;
  public static final String
      DFS_RATIS_CLIENT_MULTILINEAR_RANDOM_RETRY_POLICY_DEFAULT =
      ScmConfigKeys.DFS_RATIS_CLIENT_MULTILINEAR_RANDOM_RETRY_POLICY_DEFAULT;
  public static final String DFS_RATIS_CLIENT_EXPONENTIAL_BACKOFF_BASE_SLEEP =
      ScmConfigKeys.DFS_RATIS_CLIENT_EXPONENTIAL_BACKOFF_BASE_SLEEP;
  public static final TimeDuration DFS_RATIS_CLIENT_EXPONENTIAL_BACKOFF_BASE_SLEEP_DEFAULT =
      ScmConfigKeys.DFS_RATIS_CLIENT_EXPONENTIAL_BACKOFF_BASE_SLEEP_DEFAULT;
  public static final String
      DFS_RATIS_CLIENT_EXPONENTIAL_BACKOFF_MAX_SLEEP =
      ScmConfigKeys.DFS_RATIS_CLIENT_EXPONENTIAL_BACKOFF_MAX_SLEEP;
  public static final TimeDuration
      DFS_RATIS_CLIENT_EXPONENTIAL_BACKOFF_MAX_SLEEP_DEFAULT =
      ScmConfigKeys.DFS_RATIS_CLIENT_EXPONENTIAL_BACKOFF_MAX_SLEEP_DEFAULT;
